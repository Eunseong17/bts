    ...
    def __getitem__(self, idx):
        ...
        if self.mode == 'train':
            ...
            if self.args.do_kb_crop is True:
                ...
                depth_gt = depth_gt.crop((left_margin, top_margin, left_margin + 928, top_margin + 512))
                image = image.crop((left_margin, top_margin, left_margin + 928, top_margin + 512))
            ...
            if self.args.do_kb_crop is True:
                ...
                if self.mode == 'online_eval' and has_valid_depth:
                    depth_gt = depth_gt[top_margin:top_margin + 512, left_margin:left_margin + 928, :]
